...
?>
    ...
    <head>
        <title>สถิติการสั่งซื้อวัสดุ</title>
        <meta charset="utf-8">
                ...
                <tr>
                    ...
                    <td>
                        <select class="form-control" name='year' id='year'>
                            ...
                            <?PHP
                            $sql_year = "SELECT DISTINCT year(da_buydate) AS YEAR FROM `durablearticles_order` WHERE da_buydate GROUP BY da_buydate ASC";
                    ...
                    <td class=" p-2"><input class="btn btn-primary" type='button' id='btn1' name='btn1' value='ประมวลผล'></td>
                </tr>
            </table>
