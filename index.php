      ...
      <div id="login">
        ...
        <form action="./Check.php" method="POST">
          ...
          <fieldset class="clearfix">
            ...
            <p ><span class="fa fa-user"></span><input type="text" name="username"  Placeholder="" pattern="(?=.*[a-z]).{4-10}" oninvalid="this.setCustomValidity('กรุณากรอก ชื่อผู้ใช่ หรือ อักษรชื่อผู้ใข้ไม่ถูกต้อง')" required ></p> <!-- JS because of IE support; better: placeholder="Username" -->
